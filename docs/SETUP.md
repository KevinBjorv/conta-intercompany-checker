...
See [RETENTION.md](RETENTION.md) for a concrete temporary-history profile, operator responsibilities and the reproducible isolated pruning test. The profile is a starting point for customer approval, not a statement of statutory record-retention requirements.
